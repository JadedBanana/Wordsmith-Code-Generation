        ...
        # If there's a directional tag in the entry, then we need to do a little more work.
            ...
            if 'dont_drop' in entry2:
                ...
                # Facing (typically chests)
                    ...
                    # Double blocks (doors!)
                    if 'double' in entry2:
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run setblock ~ ~ ~ minecraft:' + entry2['block'] + '[half=lower,facing=north' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=0}] run setblock ~ ~1 ~ minecraft:' + entry2['block'] + '[half=upper,facing=north' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run setblock ~ ~ ~ minecraft:' + entry2['block'] + '[half=lower,facing=east' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=1}] run setblock ~ ~1 ~ minecraft:' + entry2['block'] + '[half=upper,facing=east' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run setblock ~ ~ ~ minecraft:' + entry2['block'] + '[half=lower,facing=south' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=2}] run setblock ~ ~1 ~ minecraft:' + entry2['block'] + '[half=upper,facing=south' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run setblock ~ ~ ~ minecraft:' + entry2['block'] + '[half=lower,facing=west' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                        full += 'execute at @e[type=minecraft:armor_stand,tag=spawner,scores={jrngResult=3}] run setblock ~ ~1 ~ minecraft:' + entry2['block'] + '[half=upper,facing=west' + (',' + str(entry2['required_tag']).replace('{', '').replace('\'', '').replace('}', ']').replace(' ', '').replace(':', '=').replace('{', '') + '' if 'required_tag' in entry2 else ']') + (entry2['required_nbt'] if 'required_nbt' in entry2 else '') + '\n'
                    else:
